...
public class ItemRedBean extends ItemFood {
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) {
        ...
        if(!worldIn.isRemote) {
            if(chance <= 20){
                player.addPotionEffect(new PotionEffect(MobEffects.SATURATION, 60*20, 5, false, true));
            }else if(chance <= 40){
                ...
                player.addPotionEffect(new PotionEffect(MobEffects.MINING_FATIGUE, 60*20, 5, false, true));
